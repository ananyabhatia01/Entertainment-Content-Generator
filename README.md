...
*(Note: Because these are standard LangChain tools, they can be easily swapped out for real APIs (like TMDb) by replacing the mock returns with `requests.get()` logic.)*
